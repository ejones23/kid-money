...
Exercise TestFlight build `0.1 (4)` using the Phase 3 matrix in `docs/SIRI_TEST_PLAN.md` on physical hardware. Record Siri routing, parameter clarification, spoken results, undo behavior, migration preservation, and persistence before beginning the Phase 4 manual interface.
