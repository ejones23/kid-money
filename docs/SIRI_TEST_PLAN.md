...
- Next checkpoint: finish the open and background context variants using a known-good ten-cent amount. Then characterize dime, nickel, quarter, dollar, and arbitrary amounts around the observed ten-cent boundary before choosing a supplemental denomination intent.
